    ...
    Themes = {
        QuangHuy = {
            ["Color Hub 1"] = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(153, 50, 204)),
                ColorSequenceKeypoint.new(0.75, Color3.fromRGB(186, 85, 211)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(138, 43, 226))
            }),

    ["Color Hub 2"] = Color3.fromRGB(25, 0, 50),
    ["Color Stroke"] = Color3.fromRGB(186, 85, 211),
    ["Color Theme"] = Color3.fromRGB(147, 51, 234),
    ["Color Text"] = Color3.fromRGB(230, 200, 255),
    ["Color Dark Text"] = Color3.fromRGB(180, 150, 220),
    ["Color Discord Text"] = Color3.fromRGB(230, 200, 255),
    ["Color Discord Stats"] = Color3.fromRGB(200, 170, 240),
    ["Color Discord Border"] = Color3.fromRGB(186, 85, 211),
    ["Color Profile Border"] = Color3.fromRGB(186, 85, 211),
    ["Color Card Border"] = Color3.fromRGB(186, 85, 211),
    ["Color Toggle On"] = Color3.fromRGB(147, 51, 234),
    ["Color Toggle Off"] = Color3.fromRGB(60, 30, 90),
    ["Color Toggle Knob On"] = Color3.fromRGB(230, 200, 255),
    ["Color Toggle Knob Off"] = Color3.fromRGB(150, 120, 190),
    ["Color Toggle Border"] = Color3.fromRGB(186, 85, 211),
    ["Border Thickness"] = 1.5,
    ["UI Border Color"] = Color3.fromRGB(186, 85, 211),
}
    },
    Info = {
        Version = "1.2.0"
...
local SetProps, SetChildren, InsertTheme, Create do
    ...
    pcall(Save, "VoidHub Library.json")
end
...
function bearlib:SetTheme(NewTheme)
    ...
    SaveJson("VoidHub Library.json", bearlib.Save)
...
function bearlib:MakeWindow(Configs)
    ...
    MinimizedIcon = Create("ImageLabel", MinimizedContainer, {
        ...
        AnchorPoint = Vector2.new(0, 0.5),
        BackgroundTransparency = 1,
        Image = "rbxassetid://126161789124643",
    ...
    function Window:MinimizeBtn()
        ...
        if Minimized then
            MinimizeButton.Image = "rbxassetid://11354741327"
    ...
    task.spawn(function()
        ...
        ToggleButton.Image = "rbxassetid://126161789124643"
...
local function CreateNotification(Icon, Title, Message, Duration)
    ...
    IconImage.Image = Icon or "rbxassetid://126161789124643"
...
function bearlib:Notify(Configs)
    ...
    local Icon = Configs.Icon or "rbxassetid://126161789124643"
